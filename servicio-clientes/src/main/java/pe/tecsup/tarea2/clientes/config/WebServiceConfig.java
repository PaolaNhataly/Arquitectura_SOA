package pe.tecsup.tarea2.clientes.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public ServletRegistrationBean<MessageDispatcherServlet> messageDispatcherServlet(
        ...
        // El WSDL final queda accesible en /ws/clientes.wsdl
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema clientesSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://shanira.tarea2/clientes");
